...
2. **Multi-Step Workflow:** Powered by `@langchain/openai`, the agent reasons over constraints and explicitly asks clarification questions if conflicts are found between user input and venue policies.
